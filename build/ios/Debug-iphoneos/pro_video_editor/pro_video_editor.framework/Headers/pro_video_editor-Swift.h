...
#ifndef PRO_VIDEO_EDITOR_SWIFT_H
#define PRO_VIDEO_EDITOR_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="pro_video_editor",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
///   </li>
/// </ul>
SWIFT_CLASS("_TtC16pro_video_editor20ProVideoEditorPlugin")
@interface ProVideoEditorPlugin : NSObject <FlutterPlugin>
...
@class FlutterError;
@interface ProVideoEditorPlugin (SWIFT_EXTENSION(pro_video_editor)) <FlutterStreamHandler>
